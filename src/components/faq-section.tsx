  ...
  const faqs = [
    {
      ...
      answer:
        "Все права принадлежат вам. РифмоСинтез автоматически регистрирует авторское право на каждое созданное произведение. Вы полностью владеете своей музыкой, текстами и видеоклипами.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Да, мы интегрированы с Spotify, Apple Music, YouTube Music и другими платформами. Публикация происходит в один клик прямо из РифмоСинтез.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Нет. РифмоСинтез разработан для всех — от новичков до профессионалов. Просто опишите, что хочешь создать, и ИИ сделает всё остальное. Технические детали опциональны.",
    },
    {
      question: "Сколько стоит использование РифмоСинтез?",
      answer:
