...
const testimonials = [
  {
    ...
    content:
      "За месяц выпустил 8 треков с клипами. РифмоСинтез делает за час то, на что раньше уходила неделя. Мой голос уже купили 200+ раз в маркетплейсе.",
  },
  {
    name: "Елена Соколова",
  ...
  },
  {
    ...
    content:
      "РифмоСинтез изменил мой рабочий процесс полностью. Генерирую демо за минуты, клиенты в восторге. Качество мастеринга сравнимо со студией.",
  },
]
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Реальные истории от артистов, которые используют РифмоСинтез для создания музыки
          </p>
        </div>
